...
class CircleAdmin(admin.ModelAdmin):
    ...
    actions = ['make_verified', 'make_unverified', 'download_today_rides']  # Colocamos en esta variable una
    # lista de las acciones que nosotros creamos.

    def make_verified(self, request, queryset):
        """Cambia círculos a verificados"""
        queryset.update(verified=True)  # Actualizamos el campo de verified del query que le mandamos del
        # modelo Circle.
