...
class Circle(CRideModel):
    ...
    slug_name = models.SlugField(unique=True,)  # Slug es como un identificador para modelos que no sean de
    # personas. En el modelo de personas o User el slug es el username
    ...
    members = models.ManyToManyField(
        ...
        through_fields=('circle', 'user')  # Especificamos los campos en una tupla que teniamos en el modelo
        # Membership que se relacionaran. Este atributo se lo coloca cuando tengas en el modelo intermedio mas
        # de una referencia a uno de los modelos relacionados, en este caso teniamos a mas de una llamada al
        # modelo User como ForeignKey ('user' y 'ivited_by'), sino colocas esto Django te lo alertara.
