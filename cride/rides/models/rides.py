...
class Ride(CRideModel):
    ...
    rating=models.FloatField(null=True)  # Calificacion del viaje, por defecto no tendra calificacion hasta realizar el viaje
    ...
    def __str__(self):
        return '{_from} a {to} | {day} {i_time} - {f_time}'.format(
            ...
            day=self.departure_date.strftime('%a %d , %b') ,# Retornamos el dia de la semana, el numero del mes, y el mes.
